...
var mention = Object.keys(event.mentions)[0];
    ...
    var kong = 0;
			...
			var expSet = content.substring(content.lastIndexOf(" ") + 1);
    			if (args[0]=='me'){
    			 return api.sendMessage(`𝗧𝗵𝗮̀𝗻𝗵 𝗰𝗼̂𝗻𝗴 𝘁𝗵𝗮𝘆 đ𝗼̂̉𝗶 𝘀𝗼̂́ 𝗲𝘅𝗽 𝗰𝘂̉𝗮 𝗯𝗮̣𝗻 𝘁𝗵𝗮̀𝗻𝗵 ${expSet} ️🥇`, event.threadID, async() => {await Currencies.setData(event.senderID, {exp: parseInt(expSet)})}, event.messageID);
			}
			else if(args[0]=="del"){
if (args[1] == 'me'){
