...
var coinscn = Math.floor(Math.random() * 100) + 20; //random coins khi làm ở khu công nghiệp
var coinsdv = Math.floor(Math.random() * 100) + 20; //random coins khi làm ở khu dịch vụ
var coinsmd = Math.floor(Math.random() * 100) + 20; //random coins khi làm ở mỏ dầu
var coinsq = Math.floor(Math.random() * 100) + 20; //random coins khi khai thác quặng
var coinsdd = Math.floor(Math.random() * 100) + 20; //random coins khi đào đá
var coinsdd1 = Math.floor(Math.random() * 100) + 20; //random coins khi đào đá
...
module.exports.run = async ({  event, api, handleReply, Currencies, getText }) => {
    ...
    return api.sendMessage("💸== 𝗖𝗨̀𝗡𝗚 𝑹𝑰𝑶 𝑺𝑬𝑵𝑷𝑨𝑰 𝗞𝗜𝗘̂́𝗠 𝗧𝗜𝗘̂̀𝗡 𝗠𝗢̂̃𝗜 𝗡𝗚𝗔̀𝗬 ==💸" +
                "\n\n1. 𝐊𝐡𝐮 𝐜𝐨̂𝐧𝐠 𝐧𝐠𝐡𝐢𝐞̣̂𝐩 🏬" +
                "\n2. 𝐊𝐡𝐮 𝐝𝐢̣𝐜𝐡 𝐯𝐮̣ 🏢" +
                "\n3. 𝐊𝐡𝐮 𝐦𝐨̉ 𝐝𝐚̂̀𝐮 🕳️" +
                "\n4. 𝐊𝐡𝐚𝐢 𝐭𝐡𝐚́𝐜 𝐪𝐮𝐚̣̆𝐧𝐠 ⛏️" +
                "\n5. 𝐊𝐡𝐚𝐢 𝐓𝐡𝐚́𝐜 ⛰️" +
