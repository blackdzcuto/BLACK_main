module.exports.config = {
	...
	commandCategory: "Trò Chơi", // Thuộc vào nhóm nào
	usages: "latdongxu", // Cách sử dụng lệnh
...
return (Math.random() > 0.5) ? api.sendMessage("𝐌𝐚̣̆𝐭 𝐇𝐢̀𝐧𝐡 🎲", event.threadID, event.messageID) : api.sendMessage("𝐌𝐚̣̆𝐭 𝐂𝐡𝐮̛̃ 🎰", event.threadID, event.messageID);
