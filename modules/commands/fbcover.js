...
module.exports.handleReply = async ({ api, event, handleReply }) => {
    ...
    case 5:
      content.fb = input;
			...
			api.unsendMessage(handleReply.messageID);
			let c = content;
			let res = await axios.get(encodeURI(`https://hnghiep2022.araxy.repl.co/taoanhdep?id=${c.nhanvat}&tenchinh=${c.ky}&fb=${c.fb}&tenphu=${c.nen}&color=${c.color}`), { responseType: "arraybuffer" })
